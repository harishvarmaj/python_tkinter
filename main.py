...
lblage = Label(entries_frame, text="Age", font=("TimesNewRoman",14),bg="#535c68",fg="white")
lblage.grid(row=1,column=2, padx=10, pady=10, sticky='w')
txtAge=Entry(entries_frame, textvariable=age, font=("Calibri",16) , width=30)
txtAge.grid(row=1, column=3, padx=10, pady=10, sticky='w')

lbldoj = Label(entries_frame, text="D.O.J", font=("TimesNewRoman",14), bg="#535c68", fg="white")
...
lblemail = Label(entries_frame,text="Email", font=("TimesNewRoman",14),bg="#535c68",fg="white")
lblemail.grid(row=2,column=2,padx=10,pady=10,sticky='w')
txtEmail=Entry(entries_frame,textvariable=email,font=("Calibri",16),width=30)
txtEmail.grid(row=2,column=3,padx=10,pady=10,sticky='w')

lblGender = Label(entries_frame,text="Gender", font=("TimesNewRoman",14),bg="#535c68",fg="white")
...
lblContact = Label(entries_frame,text="Contact No", font=("TimesNewRoman",14),bg="#535c68",fg="white")
...
lblAddress = Label(entries_frame, text="Address", font=("TimesNewRoman", 16), bg="#535c68", fg="white")
